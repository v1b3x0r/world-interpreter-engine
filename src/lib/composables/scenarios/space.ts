...
export const space: Record<string, Scenario> = {
	en: {
		id: 'space',
		name: 'Space Station',
		icon: '🚀',
		description: 'Oxygen, power, crew — the cosmos never sleeps',
		story: 'Crew woke, O₂ stable, but reactor spiked...',
	...
	th: {
		...
		events: [
			{ type: 'presence.arrived', timestamp: '06:00', actor: 'Crew Alpha' },
			{ type: 'routine.hit', timestamp: '06:15', actor: 'ระบบ O₂' },
			{ type: 'session.start', timestamp: '07:00', device: 'Lab Module' },
			{ type: 'anomaly', timestamp: '08:30', zone: 'Reactor Bay', severity: 'critical' },
			{ type: 'recovery', timestamp: '08:45', zone: 'Reactor Bay' },
			{ type: 'cycle.complete', timestamp: '11:00', device: 'Experiment Pod', duration_min: 240 },
		...
		interpreter: {
			...
			tone: 'mission',
			map: {
				'presence.arrived': '{actor} — เริ่มกะแล้ว',
				'presence.left': '{actor} — หมดกะ',
				'session.start': '{device} ออนไลน์',
				'session.end': '{device} ปิดระบบ · {duration_min} นาที',
				anomaly: '🔴 แจ้งเตือน: {zone} — ตรวจพบความผิดปกติ',
				recovery: '✓ {zone} — กลับสู่สถานะปกติ',
				'routine.hit': '{actor} — ตรวจสอบเสร็จสิ้น',
				'routine.missed': '⚠ {actor} — พลาดการตรวจสอบตามกำหนด',
				'cycle.complete': '{device} — รอบเสร็จสิ้น · {duration_min} นาที',
				'threshold.crossed': '{zone} — เกินเกณฑ์',
			},
		},
	},
};
